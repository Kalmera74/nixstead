{
  stateful = true;
  paths = ["tests/services/arr-integrations/arr-smoke.nix" "tests/services/arr-integrations/arr-smoke-recovery.nix" "tests/services/arr-integrations/arr-smoke-scenario.py" "tests/services/arr-integrations/arr-smoke-secrets.py" "tests/services/swaparr/image.nix" "modules/services/arr/lidarr.nix"];
  checks.config = {
    file = ./config.nix;
